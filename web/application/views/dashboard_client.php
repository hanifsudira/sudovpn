...
<html>
  <head>
    ...
    <title>SUDO VPN | Client Dashboard</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>SUDO</b>-VPN</span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> View Profile</a></li>
                <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Edit Profile</a></li>
                <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Account Management</a></li>
              </ul>
            </li>
    ...
    <!-- jQuery 2.1.4 -->
    <script src="<?php echo base_url(); ?>assets/lte/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <!-- jQuery UI 1.11.4 -->
