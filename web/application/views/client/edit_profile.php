  ...
  <div class='login'>
    <div class='container'>
      ...
      <br><br>
            ...
            <input name="fullname" type="text" id="inputName" value="<?php echo $list['fullname'];?>" required>
      ...
      <input name="id_user" type="hidden" id="inputEmail" value="<?php echo $list['id_user'];?>" required>
